...
<symbols>
<symbol name="AVR128DB48-I/PT">
<pin name="PA5" x="2.54" y="0" length="middle"/>
<pin name="PA6" x="2.54" y="-2.54" length="middle"/>
<pin name="PA7" x="2.54" y="-5.08" length="middle"/>
<pin name="PB0" x="2.54" y="-7.62" length="middle"/>
<pin name="PB1" x="2.54" y="-10.16" length="middle"/>
<pin name="PB2" x="2.54" y="-12.7" length="middle"/>
<pin name="PB3" x="2.54" y="-15.24" length="middle"/>
<pin name="PB4" x="2.54" y="-17.78" length="middle"/>
<pin name="PB5" x="2.54" y="-20.32" length="middle"/>
<pin name="PC0" x="2.54" y="-22.86" length="middle"/>
<pin name="PC1" x="2.54" y="-25.4" length="middle"/>
<pin name="PC2" x="2.54" y="-27.94" length="middle"/>
<pin name="PC3" x="2.54" y="-30.48" length="middle"/>
<pin name="VDDIO2" x="2.54" y="-33.02" length="middle" direction="pwr"/>
<pin name="GND_2" x="2.54" y="-35.56" length="middle" direction="pas"/>
<pin name="PC4" x="2.54" y="-38.1" length="middle"/>
<pin name="PC5" x="2.54" y="-40.64" length="middle"/>
<pin name="PC6" x="2.54" y="-43.18" length="middle"/>
<pin name="PD0" x="2.54" y="-45.72" length="middle"/>
<pin name="PD1" x="2.54" y="-48.26" length="middle"/>
<pin name="PD2" x="2.54" y="-50.8" length="middle"/>
<pin name="PD3" x="2.54" y="-53.34" length="middle"/>
<pin name="PD4" x="2.54" y="-55.88" length="middle"/>
<pin name="24" x="2.54" y="-58.42" length="middle"/>
<pin name="PD5" x="63.5" y="-58.42" length="middle" rot="R180"/>
<pin name="PD6" x="63.5" y="-55.88" length="middle" rot="R180"/>
<pin name="PD7" x="63.5" y="-53.34" length="middle" rot="R180"/>
<pin name="AVDD" x="63.5" y="-50.8" length="middle" direction="pwr" rot="R180"/>
<pin name="GND_3" x="63.5" y="-48.26" length="middle" direction="pas" rot="R180"/>
<pin name="PE0" x="63.5" y="-45.72" length="middle" rot="R180"/>
<pin name="PE1" x="63.5" y="-43.18" length="middle" rot="R180"/>
<pin name="PE2" x="63.5" y="-40.64" length="middle" rot="R180"/>
<pin name="PE3" x="63.5" y="-38.1" length="middle" rot="R180"/>
<pin name="PF0_(XTAL32K1)" x="63.5" y="-35.56" length="middle" rot="R180"/>
<pin name="PF1_(XTAL32K2)" x="63.5" y="-33.02" length="middle" rot="R180"/>
<pin name="PF2" x="63.5" y="-30.48" length="middle" rot="R180"/>
<pin name="PF3" x="63.5" y="-27.94" length="middle" rot="R180"/>
<pin name="PF4" x="63.5" y="-25.4" length="middle" rot="R180"/>
<pin name="PF5" x="63.5" y="-22.86" length="middle" rot="R180"/>
<pin name="PF6" x="63.5" y="-20.32" length="middle" rot="R180"/>
<pin name="UPDI" x="63.5" y="-17.78" length="middle" rot="R180"/>
<pin name="VDD" x="63.5" y="-15.24" length="middle" direction="pwr" rot="R180"/>
<pin name="GND" x="63.5" y="-12.7" length="middle" direction="pas" rot="R180"/>
<pin name="PA0_(XTALHF1)" x="63.5" y="-10.16" length="middle" rot="R180"/>
<pin name="PA1_(XTALHF2)" x="63.5" y="-7.62" length="middle" rot="R180"/>
<pin name="PA2" x="63.5" y="-5.08" length="middle" rot="R180"/>
<pin name="PA3" x="63.5" y="-2.54" length="middle" rot="R180"/>
<pin name="PA4" x="63.5" y="0" length="middle" rot="R180"/>
...
<devicesets>
<deviceset name="AVR128DB48-I/PT" prefix="U">
<gates>
<gate name="A" symbol="AVR128DB48-I/PT" x="0" y="0"/>
</gates>
<devices>
...
<connect gate="A" pin="PA0_(XTALHF1)" pad="44"/>
<connect gate="A" pin="PA1_(XTALHF2)" pad="45"/>
<connect gate="A" pin="PA2" pad="46"/>
<connect gate="A" pin="PA3" pad="47"/>
<connect gate="A" pin="PA4" pad="48"/>
...
<connect gate="A" pin="PC5" pad="17"/>
<connect gate="A" pin="PC6" pad="18"/>
<connect gate="A" pin="PD0" pad="19"/>
<connect gate="A" pin="PD1" pad="20"/>
<connect gate="A" pin="PD2" pad="21"/>
<connect gate="A" pin="PD3" pad="22"/>
<connect gate="A" pin="PD4" pad="23"/>
<connect gate="A" pin="PD5" pad="25"/>
<connect gate="A" pin="PD6" pad="26"/>
<connect gate="A" pin="PD7" pad="27"/>
<connect gate="A" pin="PE0" pad="30"/>
<connect gate="A" pin="PE1" pad="31"/>
<connect gate="A" pin="PE2" pad="32"/>
<connect gate="A" pin="PE3" pad="33"/>
<connect gate="A" pin="PF0_(XTAL32K1)" pad="34"/>
<connect gate="A" pin="PF1_(XTAL32K2)" pad="35"/>
<connect gate="A" pin="PF2" pad="36"/>
<connect gate="A" pin="PF3" pad="37"/>
<connect gate="A" pin="PF4" pad="38"/>
<connect gate="A" pin="PF5" pad="39"/>
<connect gate="A" pin="PF6" pad="40"/>
<connect gate="A" pin="UPDI" pad="41"/>
<connect gate="A" pin="VDD" pad="42"/>
<connect gate="A" pin="VDDIO2" pad="14"/>
</connects>
<technologies>
<technology name="">
...
<wire x1="0.254" y1="-7.62" x2="0.254" y2="2.54" width="0.1524" layer="47"/>
<wire x1="0.254" y1="2.54" x2="0.254" y2="2.921" width="0.1524" layer="47"/>
<wire x1="7.366" y1="-7.62" x2="7.366" y2="2.54" width="0.1524" layer="47"/>
...
<wire x1="3.81" y1="-8.89" x2="10.16" y2="-8.89" width="0.1524" layer="47"/>
<wire x1="10.16" y1="-8.89" x2="10.541" y2="-8.89" width="0.1524" layer="47"/>
...
<text x="-11.9634" y="-14.732" size="1.27" layer="47" ratio="6" rot="SR0">Default Padstyle: EX59Y59D39P</text>
<text x="-11.2014" y="-17.272" size="1.27" layer="47" ratio="6" rot="SR0">Pin 1 Padstyle: SX59Y59D39P</text>
<text x="-10.9982" y="-18.542" size="1.27" layer="47" ratio="6" rot="SR0">Alt 1 Padstyle: OX60Y90D30P</text>
<text x="-10.9982" y="-19.812" size="1.27" layer="47" ratio="6" rot="SR0">Alt 2 Padstyle: OX90Y60D30P</text>
...
<text x="10.668" y="-4.1148" size="0.635" layer="47" ratio="4" rot="SR0">0.4in/10.16mm</text>
...
<devicesets>
<deviceset name="24LC32A-I/P" prefix="U">
<gates>
<gate name="A" symbol="24LC32A-I/P" x="0" y="0"/>
</gates>
<devices>
...
<technology name="">
<attribute name="COPYRIGHT" value="Copyright (C) 2024 Ultra Librarian. All rights reserved." constant="no"/>
<attribute name="MANUFACTURER_PART_NUMBER" value="24LC32A-I/P" constant="no"/>
<attribute name="MFR_NAME" value="Microchip" constant="no"/>
</technology>
</technologies>
</device>
...
<part name="U1" library="AVR128DB48-IPT" deviceset="AVR128DB48-I/PT" device=""/>
<part name="U2" library="24LC32A-IP" deviceset="24LC32A-I/P" device=""/>
...
<instance part="U1" gate="A" x="38.1" y="152.4" smashed="yes">
<attribute name="NAME" x="66.3956" y="161.5186" size="2.0828" layer="95" ratio="6" rot="SR0"/>
<attribute name="VALUE" x="65.7606" y="158.9786" size="2.0828" layer="96" ratio="6" rot="SR0"/>
</instance>
<instance part="U2" gate="A" x="43.18" y="35.56" smashed="yes">
